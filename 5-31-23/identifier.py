...
class Identifier:
    def __init__(self, motor1, motor2, motor3, motor4, motor5):
        ...
        self.f1 = round(0.8 * self.MAX_RANGE * 0.8)
        self.f2 = round(0.8 * self.MAX_RANGE * 1.6)
        self.f3 = round(0.8 * self.MAX_RANGE * 1.7)
        self.f4 = round(0.8 * self.MAX_RANGE * 1.3)
        self.f5 = round(0.8 * self.MAX_RANGE * 0.9)
